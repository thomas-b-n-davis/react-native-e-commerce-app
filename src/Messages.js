  ...
  renderItem = ({item}) => {
    ...
    if(this.state.loading ===true){
      ...
      loading1=<TextInput
                ...
                borderBottomWidth: 1,marginHorizontal:2,borderWidth:1,borderColor:'#999',marginVertical:10,borderRadius:30, height:Platform.OS === "ios"?42:42,marginBottom:Platform.OS === "ios"?42:10}}
